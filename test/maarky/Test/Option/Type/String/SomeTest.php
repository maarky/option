...
class SomeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('maarky\Option\Type\String\Some', new Some('a'));
    }

    public function testSome_wrongType()
    {
        $this->expectException('TypeError');
        $this->assertInstanceOf('maarky\Option\Type\String\Some', new Some(1));
    }

    public function testSome_withNull()
    {
        $this->expectException('TypeError');
        $this->assertInstanceOf('maarky\Option\Type\String\Some', new Some(null));
    }
